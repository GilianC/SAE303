...
let V = {
    ...
    graph3Rental: document.querySelector("#graph3rental"),
    graph3: document.querySelector("#graph3"),
    graph4select: document.querySelector("#select"),
    graph4sales: document.querySelector("#graph4sales"),
    selectRental: document.querySelector("#selectrental"),
    graph4rental: document.querySelector("#graph4rental")
};
